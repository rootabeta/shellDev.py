...
#define getModAddr(libraryName) (HMODULE)( 	getModAddrByHash(modHash(libraryName)) 	)

#define getFuncAddr(libraryAddress, functionName) (PVOID)( 	getFuncAddrByHash(libraryAddress, modHash(functionName)) 	)
